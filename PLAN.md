...
./gradlew.bat test          # alle Tests (188 grün)
...
Bukkit-Code (GUI, Welten, Listener, BattleManager, SidebarManager, SpectatorManager, Notifications) wird manuell via `runServer` verifiziert.
